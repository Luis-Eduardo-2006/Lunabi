...
(function() {
  ...
  const FOOTER_HTML = `
    <footer class="lu-footer">
      <div class="container">
        <div class="row g-4 mb-4">
          ...
          <div class="col-lg-4 col-md-6">
            <h5 class="footer-title">LÜNABI <span class="footer-sparkle">✨</span></h5>
            <p class="footer-about">
              Productos especiales, femeninos y en tendencia para mujeres que desean resaltar su esencia, belleza y confianza. Más que una tienda, una experiencia cercana, confiable y emocionante para cada clienta.
            </p>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 footer-links">
            ...
            <h6 class="mt-3">Te ayudamos</h6>
            <ul>
              <li><a href="contacto.html"><i class="bi bi-chat-dots me-1"></i>Contacto</a></li>
              <li><a href="libro-reclamaciones.html"><i class="bi bi-journal-text me-1"></i>Libro de reclamaciones</a></li>
            </ul>
          </div>

          <div class="col-lg-3 col-md-6 col-sm-6 footer-links">
            <h6>Pedidos y entregas</h6>
            <ul class="footer-plain">
              <li><i class="bi bi-box-seam"></i> Modalidad de pedido anticipado</li>
              <li><i class="bi bi-clock-history"></i> 15 a 20 días hábiles desde el pago</li>
              <li><i class="bi bi-currency-exchange"></i> Precios en soles peruanos (S/)</li>
              <li><i class="bi bi-truck"></i> Envíos según cobertura disponible</li>
            </ul>
            <h6 class="mt-3">Métodos de pago</h6>
          ...
          <div class="col-lg-2 col-md-12 col-sm-12 footer-links">
            <h6>Cambios y devoluciones</h6>
            <ul class="footer-plain footer-small">
              <li><i class="bi bi-patch-check"></i> Solo por producto defectuoso, incorrecto o dañado en traslado.</li>
              <li><i class="bi bi-exclamation-triangle"></i> Reporta dentro de las primeras <strong>24 horas</strong> con evidencia fotográfica.</li>
            </ul>
          </div>
      ...
      <div class="subfooter">
        &copy; 2026 LÜNABI — Gracias por confiar en nosotras <span class="footer-sparkle">✨</span>
      </div>
    </footer>
  `;
          ...
          <div class="modal-body">
            <div class="row g-4">
              ...
              <div class="col-md-7">
                ...
                <hr class="modal-sep">
                <ul class="nav nav-tabs lu-tabs" role="tablist">
                  <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tabInfo" type="button" role="tab"><i class="bi bi-info-circle-fill"></i><span>Información General</span></button></li>
                  <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tabUso" type="button" role="tab"><i class="bi bi-list-check"></i><span>Modo de Uso</span></button></li>
                  <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tabBeneficios" type="button" role="tab"><i class="bi bi-check2-circle"></i><span>Beneficios</span></button></li>
                </ul>
  ...
  const CART_HTML = `
    ...
    <aside class="cart-drawer" id="cartDrawer">
      ...
      <div class="cart-footer" id="cartFooter" style="display:none">
        ...
        <!-- Vista primaria del footer (vaciar + enviar). Se oculta cuando
             se expande el picker inline. -->
        <div class="cart-footer-primary" id="cartFooterPrimary">
        ...
        <!-- Picker inline del WhatsApp que se expande al hacer clic arriba.
             Los botones del picker se cablean en carrito.js. -->
        <div class="cart-footer-wa" id="cartFooterWa" hidden>
          <div class="cart-wa-head">
            <button class="cart-wa-back" id="cartWaBack" type="button" aria-label="Volver"><i class="bi bi-arrow-left"></i></button>
            <div class="cart-wa-head-text">
              <strong>¿Desde dónde nos escribes?</strong>
              <small>Elige tu ubicación para atenderte por el canal correcto</small>
            </div>
          </div>
          <button class="cart-wa-option" data-wa-key="local" type="button">
            <div class="cart-wa-option-icon"><i class="bi bi-geo-alt-fill"></i></div>
            <div class="cart-wa-option-body">
              <span class="cart-wa-option-label">Huancayo y alrededores</span>
              <span class="cart-wa-option-hint">Atención directa y delivery local</span>
            </div>
            <i class="bi bi-chevron-right cart-wa-option-arrow"></i>
          </button>
          <button class="cart-wa-option" data-wa-key="nacional" type="button">
            <div class="cart-wa-option-icon"><i class="bi bi-truck"></i></div>
            <div class="cart-wa-option-body">
              <span class="cart-wa-option-label">Envíos nacionales</span>
              <span class="cart-wa-option-hint">Otras regiones — pedido anticipado</span>
            </div>
            <i class="bi bi-chevron-right cart-wa-option-arrow"></i>
          </button>
        </div>
  ...
  const WA_PICKER_HTML = `
    <div class="modal fade wa-picker-modal" id="waPickerModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"><i class="bi bi-whatsapp"></i> ¿Desde dónde nos escribes?</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
          </div>
          <div class="modal-body">
            <p class="wa-picker-lead">Elige tu ubicación para atenderte por el canal correcto.</p>
            <div class="wa-picker-options">
              <button class="wa-picker-option" data-wa-key="local" type="button">
                <div class="wa-picker-icon"><i class="bi bi-geo-alt-fill"></i></div>
                <div class="wa-picker-body">
                  <span class="wa-picker-label">Huancayo y alrededores</span>
                  <span class="wa-picker-hint">Atención directa y delivery local</span>
                  <span class="wa-picker-number">—</span>
                </div>
                <i class="bi bi-arrow-right-short wa-picker-arrow"></i>
              </button>
              <button class="wa-picker-option" data-wa-key="nacional" type="button">
                <div class="wa-picker-icon"><i class="bi bi-truck"></i></div>
                <div class="wa-picker-body">
                  <span class="wa-picker-label">Envíos nacionales</span>
                  <span class="wa-picker-hint">Otras regiones del Perú — pedido anticipado</span>
                  <span class="wa-picker-number">—</span>
                </div>
                <i class="bi bi-arrow-right-short wa-picker-arrow"></i>
              </button>
  ...
  /* Carga diferida de módulos auxiliares globales (flotantes + modales).
   * Se inyectan CSS y JS dinámicamente para que estén disponibles en toda
   * la tienda sin tener que editar cada HTML. */
  function loadModule(id, css, js) {
  ...
  loadModule('luSkinTestCss', 'assets/css/skintest.css', 'assets/js/skintest.js');
  loadModule('luChatbotCss',  'assets/css/chatbot.css',  'assets/js/chatbot.js');
